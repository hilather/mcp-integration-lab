...
| [hilather/go-lab-sso](https://github.com/hilather/go-lab-sso) | LabSSO: laboratory OIDC/OAuth2 + SAML IdP with vendor clothes, operator console, `/v1`, MCP. Pinned **v1.0.0-rc.1**. Host HTTPS dest-443; management 18443. |
