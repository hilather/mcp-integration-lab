...
// (https://raw.githubusercontent.com/hilather/go-lab-mitmproxy/v1.6.2/api/jsonschema/labmitm.dev.v1alpha1.json).
// Pin is third_party/go-lab-mitmproxy @ v1.6.2 (internal/lab/vendor.go).
